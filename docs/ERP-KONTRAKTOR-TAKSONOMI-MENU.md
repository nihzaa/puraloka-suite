...
| **Penjurnalan otomatis** (invoice/pembayaran/upah → GL) | 🔴 | **SENGAJA belum dibangun** (G5, 2026-08-12), dan alasannya bukan kemalasan: pemetaan akun adalah **kebijakan akuntansi**, bukan keputusan teknis. Empat pertanyaan yang tak boleh saya tebak sendiri, tercatat di `RATIFIKASI.md`: (1) pendapatan diakui saat invoice terbit (akrual) atau saat dibayar (kas)? (2) retensi 5% → `4130 Retensi` atau `1124 Retensi Belum Ditagih`? (3) uang muka klien → `2150` lalu diakui bertahap, atau langsung pendapatan? (4) PPN keluaran belum punya akunnya di bagan yang ada. Menebaknya menghasilkan laporan keuangan yang **salah dengan meyakinkan** — dan di sini korbannya bukan layar, melainkan SPT tahunan. Mesin penguncian sudah siap dipakai begitu kebijakannya turun |
