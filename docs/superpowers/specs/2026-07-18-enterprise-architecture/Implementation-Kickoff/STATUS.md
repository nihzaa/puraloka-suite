...
| 1A.2 | Epic 4 | RLS Synchronization | 🚧 **In progress** (PR #4✅, #5) | `has_permission()` (062) + harness + Referensi (063) + fix recursion (065/ADR-005) + Operasional (066) + **Field ops (067,068 — capability progress:manage/workers:manage)**. ✅ Referensi, Operasional, Field ops. ⏳ **Financial (kasbons/invoices/payments) — GATE: butuh maintenance-window + independent review + PITR verified (belum)**. Lalu contract phase + final audit. 85 test hijau |
