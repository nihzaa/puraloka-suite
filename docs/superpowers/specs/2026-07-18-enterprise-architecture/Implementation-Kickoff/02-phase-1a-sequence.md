...
> **Status eksekusi:** lihat ledger terpusat [STATUS.md](STATUS.md). Ringkas per 2026-07-23: **1A.4 (Epic 1) ✅ · 1A.5 (Epic 2) ✅ · 1A.1 (Epic 3) ✅ merged** → berikutnya Architecture Remediation 3.5 → 1A.2 (Epic 4, RLS) ⏳ · 1A.3 (Epic 5) 🔵.
