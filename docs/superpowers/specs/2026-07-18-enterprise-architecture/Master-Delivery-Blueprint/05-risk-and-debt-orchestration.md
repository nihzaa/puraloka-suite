...
|---|---|---|---|---|---|
| S1 | Tim (begitu bertambah) mengeksekusi Program C Epic RFI/Submittals **sebelum** Program B selesai, karena dependency non-obvious (lihat [02-master-dependency-graph.md § 2, B→C](02-master-dependency-graph.md#2-kenapa-setiap-panah-ada-justifikasi-teknis-eksplisit)) tidak dibaca | Delivery/Rework | Menengah (dependency ini mudah terlewat karena tidak eksplisit di doc 04 asli) | Tinggi (kerja diulang) | Entry Criteria eksplisit per Program ([04-delivery-orchestration.md § 3](04-delivery-orchestration.md#3-entry-criteria--operasionalisasi-per-program)) **MUST** dicek sebelum Epic RFI/Submittals dimulai |
