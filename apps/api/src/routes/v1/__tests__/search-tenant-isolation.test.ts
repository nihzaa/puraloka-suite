...
async function bersihkan() {
  ...
  await c.query(`DELETE FROM approval_steps WHERE chain_id IN (SELECT id FROM approval_chains WHERE company_id IN (SELECT id FROM companies WHERE code LIKE 'iso-test-%'))`)
  await c.query(`DELETE FROM approval_chains WHERE company_id IN (SELECT id FROM companies WHERE code LIKE 'iso-test-%')`)
