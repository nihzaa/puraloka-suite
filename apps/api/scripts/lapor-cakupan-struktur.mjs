...
const RANTAI = [
  ...
  ['PONDASI',   'sloof / tie beam',               'sloof',             '%sloof%'],
  ['PONDASI',   'pondasi menerus batu kali',      'pondasi_menerus',                '%pondasi batu%'],
  ['PONDASI',   'raft / pelat pondasi',           'raft',                '%raft%'],
  ['BAWAH',     'dinding penahan tanah',          'dinding_penahan',                '%penahan tanah%'],
  ['KOLOM',     'kolom persegi beton',            'kolom',             '%kolom%'],
  ['KOLOM',     'kolom bulat beton',              'kolom_bulat',       '%kolom bulat%'],
  ['KOLOM',     'kolom baja',                     'baja_kolom',        null],
  ['KOLOM',     'kolom komposit',                 'kolom_komposit',                '%komposit%'],
  ...
  ['PELAT',     'pelat komposit / bondek',        'bondek',                '%bondek%'],
  ['TANGGA',    'tangga beton',                   'tangga',            '%tangga%'],
  ['DINDING',   'dinding geser (shear wall)',     'dinding_geser',                '%dinding geser%'],
  ...
  ['SAMBUNGAN', 'gusset / pelat buhul',           'baja_gusset',                null],
  ['SAMBUNGAN', 'sambungan momen (rigid)',        'baja_sambungan_momen',                null],
  ...
  ['ATAP',      'kuda-kuda kayu',                 'kuda_kuda_kayu',                '%kuda%kayu%'],
  ['ATAP',      'rangka atap baja ringan',        'baja_ringan',                '%baja ringan%'],
