...
const WAJAR = new Map([
  ...
  ['/admin-portal/kontrak/surat',
   'subhalaman portal, dicapai dari badan halaman `/admin-portal/kontrak/register` \n    (tautan "Surat Masuk & Keluar" di atas daftar kontrak, Task 10 Step 3) — pola \n    sama dengan /admin-portal/kontrak/asuransi di atas. Grup `g-kontrak` belum \n    diaktifkan di `lib/admin-portal-kategori.ts` (menunggu Task 12), jadi halaman \n    ini tak muncul di grid kategori "Lainnya" untuk sementara.'],
  ['/admin-portal/kontrak/change-order',
   'subhalaman portal, dicapai dari badan halaman `/admin-portal/kontrak/register` \n    (tautan "Change Order" di atas daftar kontrak, Task 10 Step 4) — pola sama \n    dengan /admin-portal/kontrak/asuransi di atas. Grup `g-kontrak` belum \n    diaktifkan di `lib/admin-portal-kategori.ts` (menunggu Task 12), jadi halaman \n    ini tak muncul di grid kategori "Lainnya" untuk sementara. Gerbang \n    `change_order:approve` (admin-only, direktur TIDAK) dipertahankan di \n    halaman itu sendiri — lihat komentar kepala berkasnya.'],
  ['/admin-portal/jadwal',
   'subhalaman portal, dicapai dari badan halaman `/admin-portal/kontrak/register` \n    (tautan "Jadwal & Baseline" ditambahkan Task 11 Step 2) — pola sama dengan \n    /admin-portal/kontrak/asuransi di atas. Grup `g-jadwal` belum diaktifkan di \n    `lib/admin-portal-kategori.ts` (menunggu Task 12), jadi halaman ini tak \n    muncul di grid kategori "Lainnya" untuk sementara.'],
  ['/admin-portal/jadwal/keterlambatan',
   'subhalaman portal, dicapai dari badan halaman `/admin-portal/kontrak/register` \n    (tautan "Analisa Keterlambatan" ditambahkan Task 11 Step 3) — pola sama \n    dengan /admin-portal/kontrak/asuransi di atas. Grup `g-jadwal` belum \n    diaktifkan di `lib/admin-portal-kategori.ts` (menunggu Task 12), jadi \n    halaman ini tak muncul di grid kategori "Lainnya" untuk sementara.'],
