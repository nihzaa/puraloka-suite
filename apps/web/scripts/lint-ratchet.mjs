...
const AMBANG = {
  ...
  // 117 → 112 → 104 (2026-08-01): 5 foto di `progress-log-list` yang semula
  ...
  'jsx-a11y/click-events-have-key-events': 104,
  // 115 → 108 (2026-08-01, `rab-section`): baris kategori/sub-kategori yang
  ...
  'jsx-a11y/no-static-element-interactions': 108,
