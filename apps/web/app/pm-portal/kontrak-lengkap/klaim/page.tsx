...
// ============================================================================
// Klaim Kontraktual — versi PM (Tahap 2, Task 14).
//
...
//     permission `projects:view`/`projects:edit` — PM punya keduanya.
...
//     PM cuma punya `klaim:setujui`+`klaim:bayar` (bukan view/kelola), jadi
//     modul itu — kalau muncul di portal PM — lewat inbox approval terpusat
//     yang sudah ada (`pm-portal/approval`), bukan halaman berdiri sendiri.
//
// Endpoint:
...
// nilai disetujui untuk KEDUA status supaya PM bisa mengoreksi turun tanpa
// tebak-tebak status mana yang diterima backend; galat 422 tetap disurfeskan
// lewat galatForm bila kombinasinya salah.
// ============================================================================
