...
// ============================================================================
// Rekonsiliasi Bank — detail satu koran. Task 35.
//
// Laporan 4-baris + baris koran belum cocok (dengan usul pencocokan bila ada)
// + form penyesuaian + tombol "Kunci Periode".
//
// ── Atomisitas status (pelajaran Task 34 — VERIFIKASI, jangan asumsikan)
//
...
// ringan di laporan, bukan diperbaiki di sini (backend di luar scope Task 35).
//
      ...
      >
        ...
        {(
          ...
          <div key={label} style={{ display: "flex", justifyContent: "space-between", fontSize: 12, padding: "3px 0" }}>
            ...
            <span style={{ fontVariantNumeric: "tabular-nums" }}>{fmtRupiah(val)}</span>
          </div>
        ))}
        <div
          style={{
