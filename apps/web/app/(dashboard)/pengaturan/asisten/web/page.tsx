...
/**
 * Asisten web — satu asisten, satu halaman.
 *
 ...
 *
 * Kunci datanya `web` (kontrak API `/ai/config/:asisten`), slug rutenya
 * `web` — kunci tak diterjemahkan karena mengubahnya berarti migrasi data.
 */

import { KartuAsisten } from "../_bersama/kartu-asisten";

export default function Halaman() {
  return <KartuAsisten asisten="web" />;
}
