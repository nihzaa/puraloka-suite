...
/*
  `@/components/layar-kosong`, BUKAN `../_bersama/layar-kosong`.

  Modul ini DIPINDAH ke components bersama oleh commit ac53a723 di main,
  dan empat halaman estimasi lain (rab, rap, kas, index) sudah ikut pindah.
  Halaman ini dikembangkan paralel di worktree, jadi masih menunjuk jalur
  lama — dan begitu di-merge, impornya menggantung.

  Ditangkap tsc saat merge, bukan saat runtime.
*/
          ...
          return (
            <li key={r.urutan} style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", gap: 10, flexWrap: "wrap" }}>
                ...
                {/* Lewat pemformat bersama: ia memaku ZONA WAKTU, sementara pemformat
                    bawaan peramban memakai zona perangkat — riwayat revisi tampil
                    beda jam untuk orang yang sama di perangkat berbeda. */}
                <span>{formatTanggalJam(r.dicatat_pada)}</span>
              </div>
