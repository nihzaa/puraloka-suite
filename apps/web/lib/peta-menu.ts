...
export const PETA_MENU: GrupMenu[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'crm-eskalasi', label: 'Riwayat Harga Material', href: '/procurement/riwayat-harga', status: 'rencana', guna: 'Penyesuaian harga untuk kontrak jangka panjang.', catatan: 'Relevan untuk kontrak >1 tahun.' },
