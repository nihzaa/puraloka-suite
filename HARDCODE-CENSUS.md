...
| A6 | `mandor/page.tsx:3258` `UNITS_GROUPED` (~15) **vs** `procurement/page.tsx:311/594/900` `UNITS` (13) | **DUA daftar satuan divergen** | [A] | Satuan pekerjaan/material = master data. Dua sumber kebenaran berbeda = bug konsistensi | Item mandor & procurement pakai satuan beda; laporan tak nyambung |
...
- **A6 unit divergen:** prioritas config tinggi — satu master `units` lookup, dipakai mandor + procurement.
